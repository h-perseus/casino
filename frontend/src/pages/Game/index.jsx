...
import betlist_bu_image from '../../assets/img/betlist_bu.png';
import betlist_bu_on_image from '../../assets/img/betlist_bu_on.png';

import close_image from '../../assets/img/close.png'
...
// const baseUrl = 'http://139.180.203.83';
const USERNAME = "아이디";
const NICKNAME = "이름";
const MOBILE = "핸드폰번호";
    ...
    renderBetHistory: function (data) {
      ...
      $.each(data, function (key, val) {
        ...
        $.each(arrBetBeads, function (key, val) {
          elemList += `<li><div class="w-[24px] h-[24px] bg-cover ${val}"></div></li>`;
        });
        ...
        if (val.game_log.game_result) {
          resultImg = `<div class="w-[24px] h-[24px] bg-cover ${val.game_log.game_result}"></div>`;
        }
...
const PlayerGame = {
  ...
  //    }
    ...
    initMulitpleSession: function () {
      ...
      Cookies.set('sessionid', 'b0s9w5relmvuw8ko0pai39807e6lxojd');
  ...
  //          $('#winning-amount').find('b').html(LOSE);
        ...
        auth: function () {
            $.ajax({
              ...
              method: 'POST',
              data: {
                'username': 'chungmugong',
                'password': 'password123',
                'lang': 'kr',
                '_token': $('#_token').val()
              },
              success: function (resp) {
                // PlayerGame.api.post.gameBetHistory(1);
              },
              error: function (resp) {
                alert(LOGIN_ERROR);
              },
                        ...
                        <main>
                            <div className="dash-area">
                                ...
                                <div className="bet_table hidden">
                                    ...
                                    <div className="close_2"><a href="#"><img src={close_image} width="17" height="21" alt=""/></a></div>
                                </div>                  
                                </div>
                                ...
                                <table width="100%" border="0" cellPadding="0" cellSpacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <thead>
                                            ...
                                            <td className="w-[60px] bg-[#3B2042]" align="center" >테이블</td>
                                            <td className="w-[60px] bg-[#3B2042]" align="center" >Shoe</td>
                                            <td className="w-[120px] bg-[#3B2042]" align="center" >벳</td>
                                            <td align="center bg-[#3B2042]" >플레이어</td>
                                            <td align="center bg-[#3B2042]" >뱅커</td>
                                            <td align="center bg-[#3B2042]" >타이</td>
                                            <td align="center bg-[#3B2042]" >플레이어 페어</td>
                                            <td align="center bg-[#3B2042]" >뱅커 페어</td>
                                            <td align="center bg-[#3B2042]" >결과</td>
                                            <td align="center bg-[#3B2042]" >상태</td>
                                            <td align="center bg-[#3B2042]" >winning 금액</td>
                                            <td align="center bg-[#3B2042]" >배팅전</td>
                                            <td align="center bg-[#3B2042]" >배팅후</td>
                                            <td className="w-[170px] bg-[#3B2042]" align="center" >생성일</td>
                                            </tr>
                                        </thead>
                                ...
                                <div className="close_1">
                                    <a className='action-btn' href="#">
                                        <img className="default" src={betlist_bu_image} />
                                        <img className="after-hover" src={betlist_bu_on_image} />
                                    </a>
                                </div>
                                </div>    
                            </div>
