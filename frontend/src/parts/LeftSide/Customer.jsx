...
import modal_title_ask_image from '../../assets/img/modal_title_ask.png';
import modal_desc_ask_image from '../../assets/img/modal_desc_ask.png';
import modal_top_ask_image from '../../assets/img/modal_top_ask.png';
        ...
        <Holder>
            ...
            <div className="relative z-1">
                <div className="hd-part-wrapper">
                    <div className="lf-part-wrap">
                        ...
                        <div className="ttl-div">
                            <img src={modal_title_ask_image} alt="" className="m-title"/> <br/>
                            <img src={modal_desc_ask_image} alt="" className="desc_ask"/>
                        </div>
                    </div>
                    <div className="lr-part-wrap">
                        <img src={modal_top_ask_image} alt=""/>
                    </div>
                </div>
                ...
                <div className="flex justify-center items-center pt-[25px]">
                    <a id="btn-profile-save" className="w-[112px] h-[36px] mr-2" href="#" onClick={props.close}><img src={write_image} alt=""/></a>
