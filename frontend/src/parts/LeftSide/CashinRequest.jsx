            ...
            <div className="relative z-1">
                ...
                <form id="cashin-request-modal-form" action="#">
                    <div className="check-account">
                        <p><strong className="green_text">계좌신청 버튼을 누르시면 하단에 전용계좌가 발급됩니다.</strong></p><br/>
                    ...
                    <div className="cashin-name input-r">
                        <label>+ 입금자명</label>
                        <p><strong className="white_strong_text">chungmugong 본사</strong></p>
                        <p><strong className="green_text">가입시 등록한 계좌에서 입금해주셔야 정상처리됩니다.</strong></p>
                    </div>
                    <div className="cashin-amount input-r">
                        <label>+ 입 금 액</label>
                        <input type="text" className="white_strong_text" id="cashin_amount" value="" req="" readOnly/>
                        <p><strong className="white_strong_text">원</strong><strong className="green_text">   [최저5만원부터 / 만원단위만 입금가능]</strong></p>
                    </div>
